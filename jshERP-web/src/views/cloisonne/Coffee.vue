<template>
  <a-card :bordered="false">
          ...
          <a-col :md="8" :sm="24">
            <a-form-item label="状态">
              <a-select v-model="queryParam.status" placeholder="请选择状态" allow-clear>
                ...
                <a-select-option value="0">暂停营业</a-select-option>
              </a-select>
            </a-form-item>
          </a-col>
          <a-col :md="8" :sm="24">
    ...
    <coffee-modal ref="modalForm" @ok="modalFormOk"></coffee-modal>
  </a-card>
</template>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/cloisonne/coffee/list",
          delete: "/cloisonne/coffee/delete",
          deleteBatch: "/cloisonne/coffee/deleteBatch",
          exportXlsUrl: "/cloisonne/coffee/exportXls",
          importExcelUrl: "cloisonne/coffee/importExcel",
        },
        dictOptions:{},
        superFieldList:[],
      }
    ...
    methods: {
      ...
      getSuperFieldList(){
        let fieldList=[];
        fieldList.push({type:'string',value:'shopName',text:'店铺名称',dictCode:''})
        fieldList.push({type:'string',value:'address',text:'地址',dictCode:''})
        fieldList.push({type:'string',value:'phone',text:'联系电话',dictCode:''})
        fieldList.push({type:'string',value:'businessHours',text:'营业时间',dictCode:''})
